...
public class insertMultiJobCPI160428 {
	...
	public static void main(String[] args) throws ClassNotFoundException, SQLException, IOException {
		...
		final String[] COLUMN_NAMES = new String[] {
			...
			"", //lastupdatetime timestamp without time zone DEFAULT now(),27
		};
		...
		try{
			...
			String query3="SELECT distinct JobName,categoryuid, agentuid, xmldata FROM JOB";
			...
			PushbackReader reader = new PushbackReader( new StringReader(""), 10000 );
				...
				COLUMN_NAMES[1]=COLUMN_NAMES[1].replaceAll("\\d", "")+count;
