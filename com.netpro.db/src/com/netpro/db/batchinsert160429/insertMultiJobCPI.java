...
public class insertMultiJobCPI {
	...
	public static void main(String[] args) throws ClassNotFoundException, SQLException, IOException {
		...
		String jdbcURL="jdbc:postgresql://trinity0415.cbcslkvnswmn.us-west-1.rds.amazonaws.com/trinityaws";
		String user="trinity";
		String pwd="trinity123";
		...
		try{
			...
			String query1="SELECT distinct categoryuid FROM JOBCATEGORY";
			rs=stmt.executeQuery(query1);
			while(rs.next()) 
				COLUMN_NAMES[5]=rs.getString("categoryuid");				 
			
			//select AGENT uid
			String query2="SELECT distinct agentuid FROM JCSAGENT";
