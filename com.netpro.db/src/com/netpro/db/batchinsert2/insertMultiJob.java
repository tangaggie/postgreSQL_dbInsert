package com.netpro.db.batchinsert2;
...
public class insertMultiJob {
	...
	private static void insertCPI(String[] COLUMN_NAMES,
			Connection conn, Statement stmt, Integer count, int batchSize, StringBuffer sb, CopyManager cpManager, PushbackReader reader) throws SQLException {
		// TODO Auto-generated method stub
